...
const List = ({ singlePlanet }) => {
  ...
  return (
    <div
      className='bg-gray-500 hover:scale-105 rounded-xl hover:ease-in-out hover:transition-all hover:duration-700  shadow-2xl mr-5  my-2  p-5 hover:shadow-3xl'
      style={{ width: '100%' }}>
      <h3 className='text-amber-400 mb-5 text-xl'>{date}</h3>
      <div className='flex items-start rounded-xl  '>
        <div className='flex h-12 w-12 items-center justify-center rounded-full p-2 bg-gray-400 hover:animate-spin border border-white'>
